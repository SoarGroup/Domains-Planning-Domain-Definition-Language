(define (problem taxi_outmod_hard1)
   (:domain taxi_hard_outmod)
   (:objects
         taxi001 - taxi
    ...
    (:init
        (outsidetaxi bill taxi001)
        (plocation bill cr_4)
        (outsidetaxi ayumi taxi001)
        (plocation ayumi boat_rent)
        (outsidetaxi james taxi001)
        (plocation james cr_7)
        (outsidetaxi peter taxi001)
        (plocation peter cr_1)
        (outsidetaxi jill taxi001)
        (plocation jill cr_3)
